# LT-W02-US02 - Sửa hồ sơ hội viên

## Preconditions
- Lễ tân đã đăng nhập, hồ sơ hội viên đã tồn tại thuộc chi nhánh mà Lễ tân đang phục vụ (branch scope).
- Các thay đổi không làm thay đổi nhầm dữ liệu gói, lịch sử thanh toán hoặc quyền sử dụng.

## Trigger
- Lễ tân mở một hồ sơ trong danh sách W02 và chọn **Sửa hồ sơ**.
- Màn hình liên quan: Web Lễ tân — W02 Hội viên & khách hàng, modal Sửa hồ sơ hội viên.

## Main Flow

1. Lễ tân mở modal **Sửa hồ sơ hội viên**.
2. SYS nạp dữ liệu hiện tại và khóa các field không thuộc phạm vi sửa (ví dụ: Số điện thoại, Chi nhánh tiếp nhận).
3. Lễ tân cập nhật các trường được phép (Họ tên, Email, Ngày sinh).
...
- **Business rules / logic:**
  ...
  - Sửa hồ sơ không đồng nghĩa đổi trạng thái; đổi trạng thái dùng `LT-W02-US03`.
  - Dữ liệu gói, số buổi và quyền sử dụng không bị sửa bởi flow này.

## Alternate Flows

### AF-01 - Không Có Thay Đổi
1. Lễ tân mở hồ sơ nhưng không sửa field nào.
...
**Trigger:** Lễ tân mở hồ sơ và chọn Sửa hồ sơ.

```mermaid
flowchart TB
  subgraph B["Boundary — Web Lễ tân / W02 Sửa hồ sơ hội viên"]
