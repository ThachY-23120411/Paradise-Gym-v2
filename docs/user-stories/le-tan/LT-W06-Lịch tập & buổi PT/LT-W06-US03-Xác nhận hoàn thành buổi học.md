...
## Trigger
- Lễ tân chọn nút **Xác nhận hoàn thành** (màu xanh lá) tại buổi tập trên màn hình lịch PT (W06).
- Màn hình liên quan: Web Lễ tân — W06 Lịch tập PT.

## Main Flow

1. Lễ tân chọn buổi tập cần xác nhận trên màn hình lịch PT (W06) khi khung giờ buổi tập đã kết thúc (nút `[Xác nhận hoàn thành]` có màu xanh lá).
