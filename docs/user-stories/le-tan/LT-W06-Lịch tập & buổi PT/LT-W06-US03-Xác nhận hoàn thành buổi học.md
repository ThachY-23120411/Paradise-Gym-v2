# LT-W06-US03 - Xác nhận hoàn thành buổi học

## Preconditions
- Lễ tân đã đăng nhập, buổi tập PT đang ở trạng thái `Đã đặt` (BOOKED) hoặc `Chờ xác nhận hoàn thành` (AWAITING_CONFIRMATION).

## Trigger
- Lễ tân chọn nút **Xác nhận hoàn thành** tại buổi tập trên màn hình lịch PT (W06).
- Màn hình liên quan: Web Lễ tân — W06 Lịch tập PT.

## Main Flow

1. Lễ tân chọn buổi tập cần xác nhận trên màn hình lịch PT (W06).
2. Lễ tân bấm nút **Xác nhận hoàn thành**.
...
- **Business rules / logic:**
  ...
  - Thao tác ghi nhận hoàn thành được lưu vết thời điểm và tài khoản Lễ tân thực hiện.

## Alternate Flows
- **AF-01 - Đã có sẵn 1 bên xác nhận trước đó:** Khi Lễ tân/PT/Hội viên bấm xác nhận bên còn lại, hệ thống đối soát đủ 2 bên -> Chuyển ngay sang `Hoàn thành` và trừ buổi.

## Exception Flows
- Buổi tập đã ở trạng thái `Hoàn thành` (COMPLETED) hoặc `Đã hủy` (CANCELLED): SYS từ chối thao tác.

## Activity Diagram — Swimlane
**Trigger:** Lễ tân bấm Xác nhận hoàn thành tại buổi tập trong menu W06.

```mermaid
flowchart TB
  subgraph B["Boundary — Web Lễ tân W06 / Màn hình Lịch PT"]
    subgraph L0["Swimlane — Lễ tân"]
      I01(("Initial"))
      A01["Chọn buổi tập và bấm Xác nhận hoàn thành"]
      I01 --> A01
    end
