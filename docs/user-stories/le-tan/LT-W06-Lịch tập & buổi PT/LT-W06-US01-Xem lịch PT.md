...
1. Lễ tân mở màn hình **Lịch tập PT** (W06).
2. Lễ tân gõ Tên, SĐT hoặc Mã PT để tìm và chọn HLV từ combobox **Chọn HLV để xem lịch**.
3. Lễ tân chọn Ngày/Tháng/Năm từ bộ chọn lịch (Date picker / Mini Calendar).
...
**Trigger:** Lễ tân chọn HLV và ngày để xem lịch PT trong menu W06.

```mermaid
flowchart TB
  subgraph B["Boundary — Web Lễ tân W06 / Màn hình Xem lịch PT"]
