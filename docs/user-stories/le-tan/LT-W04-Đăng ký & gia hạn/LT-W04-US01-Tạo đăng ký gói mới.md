# LT-W04-US01 - Tạo đăng ký gói mới

## Preconditions
- Lễ tân đã đăng nhập, hội viên đã có hồ sơ hợp lệ trên hệ thống và có ít nhất một gói tập đang mở bán (`selling`).
- Lễ tân thao tác trong phạm vi chi nhánh được phân quyền (branch scope).

## Trigger
- Lễ tân chọn nút **Tạo đăng ký gói mới** tại màn hình W04 Đăng ký & gia hạn.
- Màn hình liên quan: Web Lễ tân — W04 Đăng ký & gia hạn, modal **Tạo đăng ký gói mới**.

## Main Flow

1. Lễ tân mở form **Tạo đăng ký gói mới**.
2. Hội viên cung cấp SĐT hoặc Họ tên; Lễ tân nhập tra cứu và chọn Hội viên.
3. Hội viên cho biết gói muốn đăng ký; Lễ tân chọn Gói đăng ký.
4. SYS tự động pre-fill **Giá gốc hiện hành**.
5. Lễ tân chọn **Ngày bắt đầu**.
6. SYS tự động pre-fill **Ngày kết thúc dự kiến** dựa theo thời hạn của gói được chọn.
7. Lễ tân chọn **Xác nhận lưu đăng ký**.
...
```mermaid
flowchart TB
  subgraph B["Boundary — Web Lễ tân W04 / Modal Tạo đăng ký gói mới"]
