...
- Scope: Tra cứu học viên và hợp đồng gói tập PT được Lễ tân/QTV gán trực tiếp cho chính PT, xem danh sách gói của học viên, xem lộ trình/lịch sử; không hiển thị công nợ hay tài chính học viên.

## Thành phần nghiệp vụ
- Menu footer Mobile PT: `PT02 · Gói phụ trách` (trước đây là `Học viên`).
- Phân công PT do QTV / Lễ tân thực hiện trực tiếp tại quầy; PT được gán là chính thức phụ trách ngay mà không cần bước phê duyệt hay nhận yêu cầu.
- Cấu trúc 2 tab chính:
...
- Cơ chế quay lại (Back navigation): Nút `[←]` trên chi tiết lộ trình tự động nhận diện nguồn mở để quay về đúng màn hình trước đó (về Màn hình phụ danh sách gói nếu mở từ Tab 1, hoặc về Tab 2 nếu mở từ Tab 2). Nút `[←]` trên Màn hình phụ danh sách gói quay về Tab 1.
...
## User Stories
- PT02-US01: Danh sách học viên và gói phụ trách (gồm 2 tab: Học viên phụ trách và Gói đang phụ trách, cùng màn hình phụ danh sách gói của học viên).
