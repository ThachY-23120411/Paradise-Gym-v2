...
app.use('/api/v1/revenue-handovers',express.json({limit:'2mb'}));
...
app.use(API_PREFIX, require('./modules/core/memberOverview').router);
...
app.use(API_PREFIX, require('./modules/core/revenueHandovers').router);
