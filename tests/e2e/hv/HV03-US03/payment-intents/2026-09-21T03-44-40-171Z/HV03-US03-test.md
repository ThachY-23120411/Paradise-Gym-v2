...
2026-09-21T03:45:15.744Z - FAIL (post-run visual evidence audit). Sources: HV03-US01, HV03-US03 MF1-8/EF01-02, HV03-US06 MF2-4; explicit 2026-09-21 user override authorizes simulation, successful-only statusless ledger, 15min QR, pending cancel and freeze eligibility. Business docs left to main.
...
- Actual Result: {"registrationId":"778ccae3-8a12-4424-8dbb-b9628e57bf7f","intentId":"34eaffa3-2c9e-46b4-8e01-e051ef6d5825","expiry":"2026-09-21T03:59:46.159Z"}
- Status: **PASS**
...
10:44:46 21/9/2026 · Chuyển khoản Ngân hàng (VietQR)
...
- Action/Input: Continue payment; create registration and intent
- Expected Result: MF5/6 plus user override: pending registration, 15min QR intent; no final payment
- Actual Result: {"registrationId":"66dcfe69-9a01-45e3-8a77-cf37df048c22","intentId":"a9e643c3-4118-4af7-8323-62cb6d47a2ea","expiry":"2026-09-21T03:59:52.600Z"}
- Status: **PASS**
...
Disposable PostgreSQL paradise_test_hv_4916_1789962280171; 14 migrations, hashes and API/SQL assertions in results.json. No mocked API responses. Browser-only clock acceleration explicitly identified. Cleanup: {"browser":true,"server":true,"connections":true,"database":true}.
...
- Actual Result: DK001	10:44:46 21/9/2026	HV Purchase Member
...
- Action/Input: Open LT registrations for the SAME registration
- Expected Result: Same member/code and expected registration status
- Actual Result: DK002	10:44:53 17/9/2026	HV Purchase Member
HV001 · HV Payment Branch A
...
Post-run visual inspection found LT registration status clipped behind fixed columns at 1440px. DOM assertions passed, but downstream screenshots did not prove the status. Superseded by a fresh full rerun with wider LT viewport, status-cell annotation and DOM hit-test ensuring the status is not obscured. No application source drift was found.

## Final Result

FAIL (visual evidence audit); 53 automated UI assertions passed, but downstream screenshot visibility failed review. Not accepted as final evidence. Not full US acceptance or real bank integration certification.
