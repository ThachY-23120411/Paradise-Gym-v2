...
**SUPERSEDED / FAIL current-source audit:** member/index.html changed after execution, at the last handoff check. The 53 automated PASS steps below certify only their recorded hashes. Backend remained unchanged; a fresh rerun on the updated HTML replaces this evidence.

2026-09-21T03:50:17.877Z - PASS (scoped scenarios). Sources: HV03-US01, HV03-US03 MF1-8/EF01-02, HV03-US06 MF2-4; explicit 2026-09-21 user override authorizes simulation, successful-only statusless ledger, 15min QR, pending cancel and freeze eligibility. Business docs left to main.
...
- Actual Result: {"registrationId":"6822d971-7141-4272-8bea-3491178caa51","intentId":"23900281-b8d7-48d0-910a-28d89bef36b7","expiry":"2026-09-21T04:04:51.530Z"}
- Status: **PASS**
...
10:49:52 21/9/2026 · Chuyển khoản Ngân hàng (VietQR)
...
- Action/Input: Continue payment; create registration and intent
- Expected Result: MF5/6 plus user override: pending registration, 15min QR intent; no final payment
- Actual Result: {"registrationId":"613f3b34-6e92-4e56-a377-661a81ae7b29","intentId":"878b4816-701a-4b90-ba12-480fab7c487a","expiry":"2026-09-21T04:04:57.697Z"}
- Status: **PASS**
...
Final accepted evidence after the authorized source-drift retry: **53/53 UI steps PASS**, including 4 LT downstream steps. All 89 source/manifest hashes are unchanged during execution AND in the post-run pre-handoff comparison. All 23 loaded local backend modules are covered, including current catalog/operations projection changes. 53 screenshots have distinct hashes. Visual inspection confirms native-dialog annotations and unobscured LT cancelled/frozen status with same registration codes; LT viewport 2240px plus cell hit-test addresses the earlier clipped-column evidence issue. Earlier 03:44 and 03:46 runs are superseded and retain failure notices.

Disposable PostgreSQL paradise_test_hv_21648_1789962583847; 14 migrations, hashes and API/SQL assertions in results.json. No mocked API responses. Browser-only clock acceleration explicitly identified. Cleanup: {"browser":true,"server":true,"connections":true,"database":true}.
...
- Actual Result: DK001	10:49:51 21/9/2026	HV Purchase Member
...
- Action/Input: Open LT registrations for the SAME registration
- Expected Result: Same member/code and expected registration status visibly unobscured
- Actual Result: DK002	10:49:58 17/9/2026	HV Purchase Member
HV001 · HV Payment Branch A
