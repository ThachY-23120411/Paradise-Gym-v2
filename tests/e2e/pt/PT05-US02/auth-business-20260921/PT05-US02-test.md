...
Result: **PASS**. Run: 2026-09-21T01:22:34.989Z.
...
### Select PT for registered phone

Expected: PT phone activation uses explicit PT role

Actual: PT selected

Status: **PASS**

![Select PT for registered phone](./step-04-activation-role.png)

### Look up pending PT by registered phone

Expected: US02 Main Flow 1-2: registered PT phone resolves pending trainer

Actual: Pending PT resolved

Status: **PASS**

![Look up pending PT by registered phone](./step-05-phone-lookup.png)
...
![Enter activation-pt-code](./step-06-activation-pt-code.png)

### Enter activation-return-phone
...
![Enter activation-return-phone](./step-07-activation-return-phone.png)

### Change PT code to phone

Expected: Stale preview and OTP fields hidden until lookup

Actual: Previous identity invalidated

Status: **PASS**

![Change PT code to phone](./step-08-identity-change-clears-preview.png)
...
Actual: Hồ sơ tìm thấy: A*** B*** T***
PT***1
Auth Test Branch

Status: **PASS**

![Review pending trainer masked identity before activation](./step-09-profile-preview.png)
...
![Request development activation OTP](./step-10-activation-challenge.png)
...
![Enter invalid-activation-otp](./step-11-invalid-activation-otp.png)
...
![Enter activation-password](./step-12-activation-password.png)
...
![Enter activation-confirm-password](./step-13-activation-confirm-password.png)
...
![Reject invalid-activation-otp](./step-14-invalid-activation-otp.png)
...
![Enter valid-activation-otp](./step-15-valid-activation-otp.png)

## State Verification

- **PASS** activation-success real session: {"accountId":"8c8fd307-a92e-4d16-a972-f27511fb2868","trainerId":"c99f9a3e-5269-4ec1-a5d2-fa089b3aa707","httpStatus":200}
...
![activation-success: authenticated PT destination](./downstream-16-activation-success.png)
...
**PASS**; 16/16 recorded steps passed. Blocked scenarios: none.
...
Prior evidence: [2026-09-20T17-31-35-216Z](./history/2026-09-20T17-31-35-216Z/PT05-US02-test.md), [2026-09-20T17-32-26-651Z](./history/2026-09-20T17-32-26-651Z/PT05-US02-test.md), [2026-09-21T01-21-58-433Z](./history/2026-09-21T01-21-58-433Z/PT05-US02-test.md).
