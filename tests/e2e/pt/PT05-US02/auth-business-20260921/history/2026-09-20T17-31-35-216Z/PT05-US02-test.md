...
Result: **FAIL**. Run: 2026-09-20T17:28:34.616Z.
...
### Review pending trainer identity before activation

Expected: US02 field specification: actual PT name, code and branch are displayed

Actual: Expected Auth Business Trainer / PT001 / Auth Test Branch; actual Hồ sơ tìm thấy: A*** B*** T***
Chi nhánh Paradise

Status: **FAIL**

![Review pending trainer identity before activation](./step-06-profile-preview.png)
...
- **PASS** activation-success real session: {"accountId":"9ae7d350-414f-4cdc-979b-4cacbdf805f8","trainerId":"3f8eb291-c106-483a-a1e8-d39c1a629b6e","httpStatus":200}
...
- Review pending trainer identity before activation: Expected Auth Business Trainer / PT001 / Auth Test Branch; actual Hồ sơ tìm thấy: A*** B*** T***
Chi nhánh Paradise
- activation-success: authenticated PT destination: Authenticated correctly but landed on schedule; US requires PT06 overview
+ actual - expected
...
**FAIL**; 10/13 recorded steps passed. Blocked scenarios: none.
