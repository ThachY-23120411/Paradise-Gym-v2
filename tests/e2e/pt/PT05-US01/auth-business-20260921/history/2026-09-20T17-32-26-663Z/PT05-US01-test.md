...
Result: **BLOCKED**. Run: 2026-09-20T17:32:07.217Z.
...
### Blocked: Password login and invalid password

Expected: Complete actual UI scenario

Actual: response.json: Protocol error (Network.getResponseBody): No resource with given identifier found
...
![Blocked: Password login and invalid password](./step-05-blocker.png)
...
- **PASS** otp-login real session: {"accountId":"a42f29de-f61c-471c-938e-907753159558","trainerId":"70802033-6870-407d-b3ed-59896c0db581","httpStatus":200}
...
- **PASS** 2fa-login real session: {"accountId":"a42f29de-f61c-471c-938e-907753159558","trainerId":"70802033-6870-407d-b3ed-59896c0db581","httpStatus":200}
...
- Password login and invalid password: response.json: Protocol error (Network.getResponseBody): No resource with given identifier found
Response body is not available for a response that was navigated away from. Read response.body() before triggering any navigation.
- Blocked: Password login and invalid password: response.json: Protocol error (Network.getResponseBody): No resource with given identifier found
Response body is not available for a response that was navigated away from. Read response.body() before triggering any navigation.

## Final Result

**BLOCKED**; 18/19 recorded steps passed. Blocked scenarios: Password login and invalid password.
...
Prior evidence: [2026-09-20T17-31-35-227Z](./history/2026-09-20T17-31-35-227Z/PT05-US01-test.md).
