...
Executed 2026-09-20T18:26:48.984Z. Result: **PASS (scoped cases only)**.
...
### 2. commission-navigation

- Action/Input: Open Hoa hong footer menu
- Expected Result: Five navigation items; commission page active; footer matches green header
- Actual Result: ["rgb(24, 87, 64)","rgb(24, 87, 64)"]
- Status: **PASS**

![commission-navigation](./step-02-commission-navigation.png)
...
![unpaid-summary](./step-03-unpaid-summary.png)

### 4. unpaid-session-details
...
![unpaid-session-details](./step-04-unpaid-session-details.png)

### 5. qtv-same-pt-unpaid
...
![qtv-same-pt-unpaid](./step-05-qtv-same-pt-unpaid.png)
...
![qtv-payout-modal](./step-06-qtv-payout-modal.png)

### 7. qtv-method-options
...
![qtv-method-options](./step-07-qtv-method-options.png)
...
![qtv-cash-fields](./step-08-qtv-cash-fields.png)

### 9. qtv-cash-input-before-submit
...
![qtv-cash-input-before-submit](./step-09-qtv-cash-input-before-submit.png)
...
![qtv-paid-result](./step-10-qtv-paid-result.png)

### 13. paid-pull-touch-refresh

- Action/Input: Browser CDP touch swipe down 100px from page scrollTop=0
...
![paid-pull-touch-refresh](./step-13-paid-pull-touch-refresh.png)

### 14. legacy-paid-null-warning
...
![legacy-paid-null-warning](./step-14-legacy-paid-null-warning.png)
...
![show-month-input](./step-15-show-month-input.png)

### 16. no-completed-entries
...
![no-completed-entries](./step-16-no-completed-entries.png)

### 17. return-overview

- Action/Input: Return to overview using footer
- Expected Result: Only overview active; footer remains usable
- Actual Result: Overview active
- Status: **PASS**

![return-overview](./step-17-return-overview.png)

### 18. overview-shortcut-preserves-period

- Action/Input: Open commission shortcut from overview
- Expected Result: Same dedicated screen and previously selected period, without modal
- Actual Result: {"commTotalAmount":"0 VNĐ","commSessionsCount":"0 buổi","commBaseRevenue":"0 đ","commStatusBadge":"Chờ chi trả"}
- Status: **PASS**

![overview-shortcut-preserves-period](./step-18-overview-shortcut-preserves-period.png)
...
![real-api-error](./step-19-real-api-error.png)

### 20. real-api-retry-success
...
![real-api-retry-success](./step-20-real-api-retry-success.png)

### 21. paid-with-missing-current-config
...
![paid-with-missing-current-config](./step-21-paid-with-missing-current-config.png)
...
![show-month-input](./step-22-show-month-input.png)

### 23. missing-config-warning
...
![missing-config-warning](./step-23-missing-config-warning.png)

### 24. own-ui-after-forbidden-api
...
![own-ui-after-forbidden-api](./step-24-own-ui-after-forbidden-api.png)
...
![open-overview](./step-25-open-overview.png)

### 26. commission-navigation
...
![commission-navigation](./step-26-commission-navigation.png)

### 28. zero-rate-with-completed-entry
...
![zero-rate-with-completed-entry](./step-28-zero-rate-with-completed-entry.png)

### 29. paid-responsive-320

- Action/Input: Resize paid statement to 320px
- Expected Result: Paid content remains visible; no horizontal document overflow
- Actual Result: {"width":320,"scroll":320,"commTotalAmount":"80.000 VNĐ","commSessionsCount":"2 buổi","commBaseRevenue":"320.000 đ","commStatusBadge":"Đã chi trả"}
- Status: **PASS**

![paid-responsive-320](./step-29-paid-responsive-320.png)

### 30. paid-responsive-360
...
![paid-responsive-360](./step-30-paid-responsive-360.png)

### 31. paid-responsive-768
...
![paid-responsive-768](./step-31-paid-responsive-768.png)

### 32. paid-responsive-1440
...
- Actual Result: {"commTotalAmount":"80.000 VNĐ","commSessionsCount":"2 buổi","commBaseRevenue":"320.000 đ","commStatusBadge":"Đã chi trả","paidDate":"21/9/2026 01:26"}
- Status: **PASS**

![pt-paid-after-qtv-payout](./downstream-11-pt-paid-after-qtv-payout.png)

### 12. paid-frozen-after-sql-changes
...
![paid-frozen-after-sql-changes](./downstream-12-paid-frozen-after-sql-changes.png)

### 27. branch-b-own-pt-only
...
![branch-b-own-pt-only](./downstream-27-branch-b-own-pt-only.png)
...
**PASS (scoped cases only)**; 32 PASS, 0 FAIL recorded UI steps.
