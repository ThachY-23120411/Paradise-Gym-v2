...
Executed 2026-09-20T18:22:30.774Z. Result: **PASS (scoped cases only)**.
...
![real-api-error](./step-17-real-api-error.png)

### 18. real-api-retry-success
...
![real-api-retry-success](./step-18-real-api-retry-success.png)

### 19. paid-with-missing-current-config
...
![paid-with-missing-current-config](./step-19-paid-with-missing-current-config.png)
...
![show-month-input](./step-20-show-month-input.png)

### 21. missing-config-warning
...
![missing-config-warning](./step-21-missing-config-warning.png)

### 22. own-ui-after-forbidden-api
...
![own-ui-after-forbidden-api](./step-22-own-ui-after-forbidden-api.png)
...
![open-overview](./step-23-open-overview.png)

### 24. commission-navigation
...
![commission-navigation](./step-24-commission-navigation.png)

### 26. zero-rate-with-completed-entry
...
![zero-rate-with-completed-entry](./step-26-zero-rate-with-completed-entry.png)

### 27. paid-responsive-320
...
![paid-responsive-320](./step-27-paid-responsive-320.png)

### 28. paid-responsive-360
...
![paid-responsive-360](./step-28-paid-responsive-360.png)

### 29. paid-responsive-768
...
![paid-responsive-768](./step-29-paid-responsive-768.png)

### 30. paid-responsive-1440
...
- Actual Result: {"commTotalAmount":"80.000 VNĐ","commSessionsCount":"2 buổi","commBaseRevenue":"320.000 đ","commStatusBadge":"Đã chi trả","paidDate":"21/9/2026 01:22"}
- Status: **PASS**
...
![branch-b-own-pt-only](./downstream-25-branch-b-own-pt-only.png)
...
**PASS (scoped cases only)**; 30 PASS, 0 FAIL recorded UI steps.
