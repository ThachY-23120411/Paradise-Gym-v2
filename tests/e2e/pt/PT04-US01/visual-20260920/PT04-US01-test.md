...
Nguồn: [US](<E:/Desktop/para/docs/user-stories/pt/PT04-Tài khoản/PT04-US01-Xem hồ sơ và tùy chọn tài khoản PT.md>), [kế hoạch](<E:/Desktop/para/docs/reports/tab3-mobile-pt/2026-09-20-visual-alignment-implementation-plan.md>).

## Source Action Verification

### Step 1: step-01-profile-mobile

Action/Input: Thông tin hồ sơ từ API hiển thị.
Expected: Thông tin hồ sơ từ API hiển thị. Kỳ vọng chỉ thuộc phạm vi visual smoke, không thay thế AC chưa chạy.
Actual: phần tử mục tiêu hiện trên DOM; viewport 390 x 844px; document rộng 390px. 
Result: PASS trong phạm vi kiểm tra trên.

![step-01-profile-mobile](step-01-profile-mobile.png)

### Step 2: step-02-password-dialog

Action/Input: Form đổi mật khẩu mở; không submit.
Expected: Form đổi mật khẩu mở; không submit. Kỳ vọng chỉ thuộc phạm vi visual smoke, không thay thế AC chưa chạy.
Actual: phần tử mục tiêu hiện trên DOM; viewport 390 x 844px; document rộng 390px. 
Result: PASS trong phạm vi kiểm tra trên.

![step-02-password-dialog](step-02-password-dialog.png)

### Step 3: responsive-375-profile
...
![responsive-375-profile](responsive-375-profile.png)

### Step 4: responsive-412-profile
...
![responsive-412-profile](responsive-412-profile.png)

### Step 5: responsive-768-profile
...
![responsive-768-profile](responsive-768-profile.png)

### Step 6: responsive-1440-profile
...
![responsive-1440-profile](responsive-1440-profile.png)
