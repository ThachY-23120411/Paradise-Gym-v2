...
Nguồn: [US](<E:/Desktop/para/docs/user-stories/pt/PT03-Thông báo/PT03-US01-Xem và xử lý thông báo PT.md>), [kế hoạch](<E:/Desktop/para/docs/reports/tab3-mobile-pt/2026-09-20-visual-alignment-implementation-plan.md>).

## Source Action Verification

### Step 1: step-01-notifications

Action/Input: Drawer thông báo hiện; không đánh dấu đọc.
Expected: Drawer thông báo hiện; không đánh dấu đọc. Kỳ vọng chỉ thuộc phạm vi visual smoke, không thay thế AC chưa chạy.
Actual: phần tử mục tiêu hiện trên DOM; viewport 390 x 844px; document rộng 390px. 
Result: PASS trong phạm vi kiểm tra trên.

![step-01-notifications](step-01-notifications.png)
...
- US còn mô tả tab thông báo footer trong khi README PT dùng chuông header; chưa sửa Main Flow/Diagram.
