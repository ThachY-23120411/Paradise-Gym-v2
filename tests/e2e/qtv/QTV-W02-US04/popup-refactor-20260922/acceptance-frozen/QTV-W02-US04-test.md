...
Mode: final. Started source SHA256: 6457b1b72c45fa6396bcdf61cf38e3a6c265faf7883c8c443f86b2392dab2a3c. CSS SHA256: d7799dae962e59a83acc1bd87a310f1f03de4040a7ed0ba452622d9c02365af7.

Frontend: http://localhost:3001/web/; API: http://localhost:5000/api/v1.

Subject: HV001 / 40000000-0000-0000-0000-000000000001. No business mutation requests; auth/heartbeat allowed.
...
### Step 40: close-readonly-receipt

- Action/Input: close readonly receipt. Visible inputs: [{"label":"Tìm kiếm","value":""},{"label":"Phương thức","value":""},{"label":"Từ ngày","value":""},{"label":"Đến ngày","value":""}].
- Expected Result: QTV-W02-US04: close inline receipt, retain selected ledger and member
...
![close-readonly-receipt](./step-40-close-readonly-receipt.png)

### Step 42: narrow-popup-viewport-900
...
![narrow-popup-viewport-900](./step-42-narrow-popup-viewport-900.png)

### Step 43: close-popup-before-scope-change
...
![close-popup-before-scope-change](./step-43-close-popup-before-scope-change.png)

### Step 46: close-branch-A-popup
...
![close-branch-A-popup](./step-46-close-branch-A-popup.png)

### Step 49: close-branch-B-popup
...
![close-branch-B-popup](./step-49-close-branch-B-popup.png)

### Step 52: close-branch-ALL-popup
...
![close-branch-ALL-popup](./step-52-close-branch-ALL-popup.png)

### Step 53: network-abort-member-list
...
![network-abort-member-list](./step-53-network-abort-member-list.png)

### Step 54: network-retry-member-list
...
![network-retry-member-list](./step-54-network-retry-member-list.png)
...
### Step 41: pending-payment-subtab-same-member-projection
...
![pending-payment-subtab-same-member-projection](./step-41-pending-payment-subtab-same-member-projection.png)

### Step 44: branch-scope-A
...
![branch-scope-A](./step-44-branch-scope-A.png)

### Step 45: branch-A-popup-retains-scope
...
![branch-A-popup-retains-scope](./step-45-branch-A-popup-retains-scope.png)

### Step 47: branch-scope-B
...
![branch-scope-B](./step-47-branch-scope-B.png)

### Step 48: branch-B-popup-retains-scope
...
![branch-B-popup-retains-scope](./step-48-branch-B-popup-retains-scope.png)

### Step 50: branch-scope-ALL
...
![branch-scope-ALL](./step-50-branch-scope-ALL.png)

### Step 51: branch-ALL-popup-retains-scope
...
![branch-ALL-popup-retains-scope](./step-51-branch-ALL-popup-retains-scope.png)

### Step 55: qtv-popup-does-not-fetch-legacy-profile
...
![qtv-popup-does-not-fetch-legacy-profile](./step-55-qtv-popup-does-not-fetch-legacy-profile.png)

### Step 62: receptionist-existing-members-list
...
![receptionist-existing-members-list](./step-62-receptionist-existing-members-list.png)

### Step 63: receptionist-existing-profile
...
![receptionist-existing-profile](./step-63-receptionist-existing-profile.png)

## Cross-Role / Downstream Verification

### Step 56: mobile-authenticated-same-member-home
...
![mobile-authenticated-same-member-home](./step-56-mobile-authenticated-same-member-home.png)

### Step 57: mobile-same-member-schedule
...
![mobile-same-member-schedule](./step-57-mobile-same-member-schedule.png)

### Step 58: mobile-same-member-packages
...
![mobile-same-member-packages](./step-58-mobile-same-member-packages.png)

### Step 59: mobile-package-filter-all-same-registration
...
![mobile-package-filter-all-same-registration](./step-59-mobile-package-filter-all-same-registration.png)

### Step 60: mobile-same-member-payments
...
![mobile-same-member-payments](./step-60-mobile-same-member-payments.png)

### Step 61: mobile-same-member-account
...
![mobile-same-member-account](./step-61-mobile-same-member-account.png)

## Issues Found

- Step 60: mobile-same-member-payments: Mobile has no confirmed shared payment identifier; Web API has 11 confirmed records (legacy statuses: )
...
PASS assertions: 62; FAIL assertions: 1.
