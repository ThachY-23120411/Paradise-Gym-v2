...
- Action/Input: clear package search. Visible inputs: [{"label":"Tìm kiếm","value":"DK01"},{"label":"Trạng thái","value":""},{"label":"Từ ngày","value":""},{"label":"Đến ngày","value":""}].
- Expected Result: Clear readonly search and restore package list
- Actual Result: URL /web/#members; popup=true; title=HV001 - Lê Hoàng Nam; visible alerts=[]; visible grid rows=8. DOM assertions passed; screenshot requires visual audit.
- Status: PASS
...
### Step 30: narrow-popup-viewport-900

- Action/Input: narrow popup viewport 900. Visible inputs: [{"label":"Tìm kiếm","value":""},{"label":"Phương thức","value":"Chuyển khoản"},{"label":"Từ ngày","value":""},{"label":"Đến ngày","value":""}].
...
![narrow-popup-viewport-900](./step-30-narrow-popup-viewport-900.png)

### Step 31: close-popup-before-scope-change
...
![close-popup-before-scope-change](./step-31-close-popup-before-scope-change.png)

### Step 34: close-branch-A-popup
...
![close-branch-A-popup](./step-34-close-branch-A-popup.png)

### Step 37: close-branch-B-popup
...
![close-branch-B-popup](./step-37-close-branch-B-popup.png)

### Step 40: close-branch-ALL-popup
...
![close-branch-ALL-popup](./step-40-close-branch-ALL-popup.png)

### Step 41: network-abort-member-list
...
![network-abort-member-list](./step-41-network-abort-member-list.png)

### Step 42: network-retry-member-list
...
![network-retry-member-list](./step-42-network-retry-member-list.png)
...
### Step 15: profile-face-status-from-api

- Action/Input: profile face status from api. Visible inputs: [].
- Expected Result: QTV-W02-US04 Main Flow 2-8, popup navigation field table and Business Rules; Product Spec W02: biometric enrollment must come from API, not portrait presence
- Actual Result: URL /web/#members; popup=true; title=HV001 - Lê Hoàng Nam; visible alerts=[]; visible grid rows=0. DOM assertions passed; screenshot requires visual audit.
- Status: PASS

![profile-face-status-from-api](./step-15-profile-face-status-from-api.png)
...
- Action/Input: expand same registration entitlements. Visible inputs: [{"label":"Tìm kiếm","value":"DK01"},{"label":"Trạng thái","value":""},{"label":"Từ ngày","value":""},{"label":"Đến ngày","value":""}].
...
- Action/Input: filter existing package status. Visible inputs: [{"label":"Tìm kiếm","value":"DK01"},{"label":"Trạng thái","value":"Chờ thanh toán"},{"label":"Từ ngày","value":""},{"label":"Đến ngày","value":""}].
...
- Actual Result: URL /web/#members; popup=true; title=HV001 - Lê Hoàng Nam; visible alerts=[]; visible grid rows=4. DOM assertions passed; screenshot requires visual audit.
- Status: PASS
...
![branch-scope-A](./step-32-branch-scope-A.png)

### Step 33: branch-A-popup-retains-scope
...
![branch-A-popup-retains-scope](./step-33-branch-A-popup-retains-scope.png)

### Step 35: branch-scope-B
...
![branch-scope-B](./step-35-branch-scope-B.png)

### Step 36: branch-B-popup-retains-scope
...
![branch-B-popup-retains-scope](./step-36-branch-B-popup-retains-scope.png)

### Step 38: branch-scope-ALL
...
![branch-scope-ALL](./step-38-branch-scope-ALL.png)

### Step 39: branch-ALL-popup-retains-scope
...
![branch-ALL-popup-retains-scope](./step-39-branch-ALL-popup-retains-scope.png)

### Step 43: qtv-popup-does-not-fetch-legacy-profile
...
![qtv-popup-does-not-fetch-legacy-profile](./step-43-qtv-popup-does-not-fetch-legacy-profile.png)

### Step 50: receptionist-existing-members-list
...
![receptionist-existing-members-list](./step-50-receptionist-existing-members-list.png)

### Step 51: receptionist-existing-profile
...
![receptionist-existing-profile](./step-51-receptionist-existing-profile.png)

## Cross-Role / Downstream Verification

### Step 44: mobile-authenticated-same-member-home
...
![mobile-authenticated-same-member-home](./step-44-mobile-authenticated-same-member-home.png)

### Step 45: mobile-same-member-schedule
...
![mobile-same-member-schedule](./step-45-mobile-same-member-schedule.png)

### Step 46: mobile-same-member-packages
...
![mobile-same-member-packages](./step-46-mobile-same-member-packages.png)

### Step 47: mobile-package-filter-all-same-registration
...
![mobile-package-filter-all-same-registration](./step-47-mobile-package-filter-all-same-registration.png)

### Step 48: mobile-same-member-payments
...
![mobile-same-member-payments](./step-48-mobile-same-member-payments.png)

### Step 49: mobile-same-member-account
...
![mobile-same-member-account](./step-49-mobile-same-member-account.png)

## Issues Found

- Step 48: mobile-same-member-payments: Mobile has no confirmed shared payment identifier; Web API has 11 confirmed records (legacy statuses: )
...
PASS assertions: 50; FAIL assertions: 1.
